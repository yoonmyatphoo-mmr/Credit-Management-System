        ...
        <c:choose>
            ...
            <c:otherwise>
                ...
                <div class="row">
                    ...
                    <div class="col-7"><span class="crimson-text">${results.name}</span></div>
                    <div class="col-1"><span class="crimson-text">Roll No-</span></div>
                    <div class="col-3"><span class="crimson-text">${results.studentIdentity}</span></div>
                </div>
                <div class="row">
                    <div class="col-1"><span class="crimson-text">Year</span></div>
                    <div class="col"><span class="crimson-text">${results.year} (2019-2020) Academic Year</span></div>
                </div>
                <div class="row">
                    <div class="col text-center"><span class="crimson-text">${results.semester} (GPA Sheet)</span></div>
                </div>
